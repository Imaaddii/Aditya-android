...
class ViewServiceList (val context: Context, val itemList: ArrayList<ViewServiceList_modelclass>)
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): com.exobe.Adapter.ViewServiceList.ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.view_service_list, parent, false)
        return com.exobe.Adapter.ViewServiceList.ViewHolder(view)
    }

    override fun onBindViewHolder(holder: com.exobe.Adapter.ViewServiceList.ViewHolder, position: Int) {
